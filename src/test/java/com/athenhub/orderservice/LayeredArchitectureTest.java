package com.athenhub.orderservice;
...
@AnalyzeClasses(
    packages = "com.athenhub.orderservice",
    importOptions = ImportOption.DoNotIncludeTests.class)
class LayeredArchitectureTest {

  private static final String[] DOMAIN_PACKAGES = {
    "com.athenhub.orderservice.example.domain..",
  };
  ...
  public void layeredArchitecture(JavaClasses classes) {
    Architectures.layeredArchitecture()
        ...
        .layer("Presentation")
        .definedBy("com.athenhub.orderservice..presentation..")
        .layer("Application")
        .definedBy("com.athenhub.orderservice..application..")
        .layer("Domain")
        .definedBy("com.athenhub.orderservice..domain..")
        .layer("Infrastructure")
        .definedBy("com.athenhub.orderservice..infrastructure..")
        ...
        .ignoreDependency(
            ...
            JavaClass.Predicates.resideInAPackage("com.athenhub.orderservice.global.."))
        // 빈 레이어 허용
  ...
  public void globalShouldNotDependOnDomains(JavaClasses classes) {
    ...
    // global 패키지가 없으면 스킵
    if (!hasClassesInPackage(classes, "com.athenhub.orderservice.global..")) {
      return;
    }

    noClasses()
        .that()
        .resideInAPackage("com.athenhub.orderservice.global..")
        .should()
        .dependOnClassesThat()
