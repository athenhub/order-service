package com.athenhub.orderservice.infrastructure.client.product.config;

import com.athenhub.commoncore.error.GlobalErrorCode;
import com.athenhub.orderservice.infrastructure.client.product.ProductFeignException;
